...
const credentials = {
  ...
  redirect_uris: ["https://berryb0y.github.io/meet/"],
...
module.exports.getAccessToken = async (event) => {
  ...
  return new Promise((resolve, reject) => {
    //exchange authorization code for access token with a callback after exchange, callback in this case is an arrow function with results as paramters "err" and "token"
